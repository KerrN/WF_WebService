...
namespace webServiceTestForm.wf_service {
    ...
    public interface WF_Service_Interface {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/WF_Service_Interface/deleteImages", ReplyAction="http://tempuri.org/WF_Service_Interface/deleteImagesResponse")]
        string deleteImages(string[] urls);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/WF_Service_Interface/deleteImages", ReplyAction="http://tempuri.org/WF_Service_Interface/deleteImagesResponse")]
        System.Threading.Tasks.Task<string> deleteImagesAsync(string[] urls);
    ...
    public partial class WF_Service_InterfaceClient : System.ServiceModel.ClientBase<webServiceTestForm.wf_service.WF_Service_Interface>, webServiceTestForm.wf_service.WF_Service_Interface {
        ...
        public string deleteImages(string[] urls) {
            return base.Channel.deleteImages(urls);
        }
        
        public System.Threading.Tasks.Task<string> deleteImagesAsync(string[] urls) {
            return base.Channel.deleteImagesAsync(urls);
        }
